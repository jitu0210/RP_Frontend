...
import "../pages/Binary-input"
import "../pages/Digital_inputs"
import "../pages/Events"
import "../pages/DR"
import "../pages/AnalogMeasurement"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <NavLink to="/disturbance">DR</NavLink>
            <NavLink to="/events">Events</NavLink>
            <NavLink to="/digital-inputs">DI</NavLink>
            ...
            {/* <div className="relative services-dropdown">
              ...
              {isServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                  <ServiceOption
                    option="analog"
                    label="Analog Measurements"
                    icon={icons.analog}
                  />
                  <ServiceOption
                    option="disturbance"
                    label="Disturbance Records (DR)"
                    icon={icons.disturbance}
                  />
                  <ServiceOption
                    option="events"
                    label="Events"
          ...
          >
            <div className="w-6 h-6 relative">
              <span
                className={`absolute block w-6 h-0.5 bg-gray-700 transform transition duration-300 ${
                  isMenuOpen ? "rotate-45 top-3" : "top-2"
                }`}
              ></span>
              <span
                className={`absolute block w-6 h-0.5 bg-gray-700 top-3 transition-opacity duration-300 ${
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-gray-200 bg-white/95 backdrop-blur-sm">
            <div className="py-2">
              {/* <NavLink to="/about" mobile icon={icons.about}>
                About
              </NavLink>
              <NavLink to="/contact" mobile icon={icons.contact}>
                Contact
              </NavLink> */}
              <NavLink to="/relay" mobile icon={icons.services}>
                Control
              </NavLink>
              <NavLink to="/analog">Analog</NavLink>
            <NavLink to="/disturbance-records">DR</NavLink>
            <NavLink to="/events">Events</NavLink>
            <NavLink to="/digital-inputs">DI</NavLink>
            <NavLink to="/binary-input">BI/BO</NavLink>
