...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-gray-800 px-8 py-8 rounded-xl shadow-2xl border border-gray-700">
        <div>
